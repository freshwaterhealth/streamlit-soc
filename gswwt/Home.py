...
url_blank='https://webtools.freshwaterhealthindex.org/asset/sample.xml'
#geomteric mean
def gm_df(x,y):
    a=[]
    b=[]
...
st.markdown("1. To proceed with a new analysis, obtain the results of the weights and governance survey results for your basin from the FHI webtools, and upload the results in CSV format into the \"Add Weights\" and \"Add GS Survey\" pages. The summary results will be displayed below.")
